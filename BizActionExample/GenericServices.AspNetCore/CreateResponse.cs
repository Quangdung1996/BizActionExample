...
namespace GenericServices.AspNetCore
{
    ...
    public static class CreateResponse
    {
        ...
        /// <returns></returns>
        public static ActionResult<WebApiMessageOnly> Response(StatusGeneric.IStatusGeneric status)
        {
        ...
        /// <returns></returns>
        public static ActionResult<WebApiMessageOnly> ResponseWithValidCode(this StatusGeneric.IStatusGeneric status, int validStatusCode)
        {
            if (status.IsValid)
        ...
        /// <returns></returns>
        public static IActionResult Response(this StatusGeneric.IStatusGeneric status, CreatedAtRouteResult createdRoute)
        {
            if (status.IsValid)
                return createdRoute;
        ...
        /// <returns></returns>
        public static ActionResult<T> Response<T>(this StatusGeneric.IStatusGeneric status,
        ...
        /// <returns></returns>
        public static ActionResult<WebApiMessageAndResult<T>> Response<T>(this StatusGeneric.IStatusGeneric status, T results)
        {
        ...
        /// <returns></returns>
        public static ActionResult<WebApiMessageAndResult<T>> ResponseWithValidCode<T>(this StatusGeneric.IStatusGeneric status, T results,
